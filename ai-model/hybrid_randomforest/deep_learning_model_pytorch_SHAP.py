...
def load_user_model(user_id):
    model_path = f"model/{user_id}/{user_id}_personalized_model_pytorch.pth"
    song_map_path = f"model/{user_id}/{user_id}_song_mapping.json"
